...
class NumberPlateDetector:
    """
    This class is for detecting number plates using a YOLO ONNX model.
    It performs image preprocessing, model inference, output decoding, and Non-Maximum-Supression.
    """

    def __init__(self, model_path, yaml_path, input_size=1280):
        ...
        #Load YOLO model using onnxruntime by microsoft
    ...
    def detect(self, image):
        ...
        predictions = self.session.run(None,{self.input_name: blob})[0]
